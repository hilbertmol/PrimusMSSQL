...
insert into Teilnehmer values  ('Elon','Musk',2310, 'Berlinerring 2',  'Potsdam', 'musk@gmail.com',null);
insert into Teilnehmer values  ('Steve','Jobs',1010, 'Himmel platz 1',  '7himmel', 'jobs7@gmx.de',null);
commit;
